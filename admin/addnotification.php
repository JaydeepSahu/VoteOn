    ...
    <div class="container-fluid bg-light">
            ...
            <div class="container bg-white">
                ...
                <div class="form-group">
                    ...
                    <form action="addnotificationcode.php" method="post">
                        <div class="form-group">
                            <label for="uname">Notification Title:</label>
                            <input type="text" class="form-control" id="uname" placeholder="Enter title" name="title"
                                required>
                        </div>
                        <div class="form-group">
                            <label for="pwd">Notification Description:</label>
        ...
        <div id="footer">
            ...
            <div class="lfooter">
                <h3>ABOUT PROJECT</h3>
                <p>
                    Election System & Software (ES&S) is an Omaha, Nebraska-based company that manufactures
                    and
                    services.[1] The company's offerings include vote tabulators, direct-recording election
                    (DRE)
                    machines,voter registration andelection management system, ballot-marking devices,
                    electronic poll
