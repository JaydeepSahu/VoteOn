        ...
        <div class="container">
          ...
          ?>
                ...
                <tbody>
                    <tr>
                        <td><?php echo $sn; ?></td>
                        <td><img src="../commitee/upload/logo/<?php echo $row['plogo']; ?>" height="100px"
                                width="70px" /></td>
                        <td><?php echo $row['pname']; ?></td>
                        <td><?php echo $row['pmobile']; ?></td>
                        <td><?php echo $row['pemail']; ?></td>
                        <td><?php echo $row['psecretary']; ?></td>
                        <td><a href="editparty.php"><button type="button" class="btn btn-success">
                                    EDIT
                                </button></a>
                            <a href="deleteparty.php"><button type="button" class="btn btn-danger">
                                    DELETE
                                </button></a>
                        </td>
                    </tr>
