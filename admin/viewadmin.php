...
<div class="container">
  ...
  <table class="table">
<a href="addadmin.php"><div id="add">
...
?>
    ...
    <tbody>
      <tr>
<td><?php echo $sn; ?></td>
<td><img src="../photo/<?php echo $row['adphoto'];?>" height="100px" width="70px"/></td>
<td><?php echo $row['adname']; ?></td>
<td><?php echo $row['admobile']; ?></td>
<td><?php echo $row['ademail']; ?></td>
<td><?php echo $row['addob']; ?></td>
<td><a href="editadmin.php"><button type="button" class="btn btn-success">
    EDIT
  </button></a>
  <a href="deleteadmin.php"><button type="button" class="btn btn-danger">
    DELETE
  </button></a>
  </td>
</tr>
